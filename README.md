# dbmanager
A simple database manager useed to CRUD (create, read, update, delete) data in a database.
This simple project is aimed for those who wanna develop some mobile app and need to store 
data in a database. To avoid learn all about sql, spending time, the developer can insert 
this file in his/her project and just insert the data in a easy way.
